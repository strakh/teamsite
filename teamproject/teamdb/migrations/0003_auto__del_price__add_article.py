...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teamdb_article', (
            ...
            ('autor', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teamdb.Employee'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('teamdb', ['Article'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teamdb_article')
